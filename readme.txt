...
**Modern Hotel Booking** is a free WordPress booking plugin that includes a built-in **AI Concierge** — an intelligent virtual receptionist that answers guest questions and takes reservations 24/7 by voice or by text.

Built specifically for independent property owners — **guesthouses, B&Bs, bed and breakfasts, vacation rentals, cabins, boutique hotels and holiday apartments** — who want to stop paying 15–25% commission to Airbnb and Booking.com and take direct bookings on their own website, forever.
...
No other free WordPress accommodation plugin offers this. Your AI receptionist is active the moment you enable it:

* **Answers guest questions** about your property, amenities, check-in times, house rules, and pricing — using your own data
* **Checks real-time availability** and guides guests through the complete booking process from first question to confirmed reservation
* **Voice and text** — guests can speak or type; the AI responds in kind
* **Remembers guests** across the chat session and pre-fills booking forms automatically to increase conversion
* **Responds in 15 languages** — detects the guest's language and replies accordingly
* **Powered by Google Gemini or OpenAI** — connect your own free API key in minutes
* Zero coding required — one click to activate from your WordPress admin
...
* Compulsory Cleaning Fee — auto-added to every booking as a fixed amount
...
* Multi-Select Calendar Override — set custom prices across any combination of dates, days, and room types in one operation
...
* **Guesthouses** — per-night booking logic, WhatsApp, bank transfers, professional invoicing
...
* **Cabins & Cottages** — seasonal pricing, deposits, iCal sync with existing OTA listings
...
* **PRO: Multi-Select Pricing Override** — Bulk-set custom prices across any combination of dates, days, and room types in one operation.
