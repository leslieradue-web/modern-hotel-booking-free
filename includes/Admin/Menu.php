...
class Menu
{
    ...
    public function add_plugin_admin_menu()
    {
        ...
        add_submenu_page('mhbo-hotel-booking', __('PRO Features', 'modern-hotel-booking'), __('PRO Features', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro', array('MHBO\\Admin\\Settings', 'render_pro_page'));

        // Register Pro subpages (hidden from sidebar by passing empty parent)
        add_submenu_page('', __('Extras', 'modern-hotel-booking'), __('Extras', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-extras', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('iCal Sync', 'modern-hotel-booking'), __('iCal Sync', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-ical', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('Payments', 'modern-hotel-booking'), __('Payments', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-payments', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('Webhooks', 'modern-hotel-booking'), __('Webhooks', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-webhooks', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('Analytics', 'modern-hotel-booking'), __('Analytics', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-analytics', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('Appearance', 'modern-hotel-booking'), __('Appearance', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-themes', array('MHBO\\Admin\\Settings', 'render_pro_page'));
        add_submenu_page('', __('Advanced Pricing', 'modern-hotel-booking'), __('Advanced Pricing', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro-pricing', array('MHBO\\Admin\\Settings', 'render_pro_page'));
    }
...
<td><p class="description">This feature requires the Pro add-on. <a href="https://startmysuccess.com/shop/wordpress-plugins/hotel-booking-wordpress-plugin/" target="_blank">Upgrade to Pro</a></p></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="0.01" name="payment_amount" id="mhbo_edit_payment_amount"
