...
class Menu
{
    ...
    public function enqueue_admin_assets($hook)
    {
        ...
        if (false !== strpos($hook, 'mhbo-bookings')) {
            wp_enqueue_script('fullcalendar', MHBO_PLUGIN_URL . 'assets/js/vendor/fullcalendar.global.min.js', array(), '6.1.10', true);
    ...
    {
        add_menu_page(I18n::__('Hotel Booking', 'modern-hotel-booking'), I18n::__('Hotel Booking', 'modern-hotel-booking'), 'manage_options', 'mhbo-hotel-booking', array($this, 'display_dashboard_page'), 'dashicons-building', 26);
        add_submenu_page('mhbo-hotel-booking', I18n::__('Bookings', 'modern-hotel-booking'), I18n::__('Bookings', 'modern-hotel-booking'), 'manage_options', 'mhbo-bookings', array($this, 'display_bookings_page'));
        add_submenu_page('mhbo-hotel-booking', I18n::__('Room Types', 'modern-hotel-booking'), I18n::__('Room Types', 'modern-hotel-booking'), 'manage_options', 'mhbo-room-types', array($this, 'display_room_types_page'));
        add_submenu_page('mhbo-hotel-booking', I18n::__('Rooms', 'modern-hotel-booking'), I18n::__('Rooms', 'modern-hotel-booking'), 'manage_options', 'mhbo-rooms', array($this, 'display_rooms_page'));
        add_submenu_page('mhbo-hotel-booking', I18n::__('Pricing Rules', 'modern-hotel-booking'), I18n::__('Pricing Rules', 'modern-hotel-booking'), 'manage_options', 'mhbo-pricing-rules', array($this, 'display_pricing_rules_page'));
        add_submenu_page('mhbo-hotel-booking', I18n::__('Settings', 'modern-hotel-booking'), I18n::__('Settings', 'modern-hotel-booking'), 'manage_options', 'mhbo-settings', array('MHBO\\Admin\\Settings', 'render'));

        add_submenu_page('mhbo-hotel-booking', I18n::__('PRO Features', 'modern-hotel-booking'), I18n::__('PRO Features', 'modern-hotel-booking'), 'manage_options', 'mhbo-pro', array('MHBO\\Admin\\Settings', 'render_pro_page'));
    ...
    public function display_dashboard_page()
    {
        ...
        // License check removed - Pro features removed in Free version;
        ?>
        <div class="wrap mhbo-dashboard">
            ...
            <?php if (true): // Always show Free version banner ?>
                ...
                <div class="mhbo-side-col">
                    ...
                    <div class="mhbo-card">
                        ...
                        <div style="font-size: 13px; line-height: 2;">
                            <div style="display: flex; justify-content: space-between;">
                                ...
                                <strong
                                    style="color: <?php echo false ? 'PRO' : 'Free'; ?>;"><?php echo false ? esc_html__('PRO Active', 'modern-hotel-booking') : esc_html__('Free Version', 'modern-hotel-booking'); ?></strong>
                            </div>
                            <div style="display: flex; justify-content: space-between;">
                    ...
                    <div class="mhbo-card" style="background: #f8f6f2; border-color: #e9e5de;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            <a href="<?php echo esc_url('https://startmysuccess.com'); ?>" target="_blank"
...
<tr>
<th>Pro Feature</th>
<td><p class="description">This feature requires the Pro add-on. <a href="https://startmysuccess.com/shop/wordpress-plugins/hotel-booking-wordpress-plugin/" target="_blank">Upgrade to Pro</a></p></td>
</tr>
                            ...
                            <tr>
                                ...
                                <td data-colname="<?php esc_attr_e('Total', 'modern-hotel-booking'); ?>"><?php
                                   ...
                                   if ($bk->payment_received ?? 0) {
                                       ...
                                       // translators: %s: outstanding balance amount (formatted currency)
                                       echo '<br><small style="color:#d63638;">' . esc_html(sprintf(__('Outstanding: %s', 'modern-hotel-booking'), I18n::format_currency($bk->total_price))) . '</small>';
                                   }
                                   ?></td>
